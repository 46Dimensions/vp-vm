...
echo "${green}=======================================================${reset}"
echo "${green}Vocabulary Plus Version Manager: Unix Installer (0.4.0)${reset}"
echo "${green}=======================================================${reset}"
echo ""
...
echo "0.4.0" > "$INSTALL_DIR/versions/vp-vm/current.txt"
...
# Final instructions
echo "${green}Vocabulary Plus Verson Manager 0.4.0 installed successfully${reset}"
